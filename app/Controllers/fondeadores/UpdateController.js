/**
 * Created by Enrique on 11/05/2017.
 */
antejo.controller('UpdateStockCtrl', ['$filter', 'SweetAlert','FoundFact','BancosFact','$routeParams', function($filter, SweetAlert,FoundFact,BancosFact,$routeParams) {
    var ctrl = this;
    ctrl.menu = 'info'
    ctrl.idStock = $routeParams.idStock;
    ctrl.stockholders = {
        id:null,
        businessname:'',
        name:'',
